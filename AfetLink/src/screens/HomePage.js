...
export const styles = StyleSheet.create({
  ...
  point1: { backgroundColor: '#666' },
  point2: { backgroundColor: '#555', width: 5, height: 5 },
  point3: { backgroundColor: '#444', width: 6, height: 6 },
  point4: { backgroundColor: '#555', width: 5, height: 5 },
  point5: { backgroundColor: '#666' },
  point6: { backgroundColor: '#555', width: 5, height: 5 },
  point7: { backgroundColor: '#666' },
  sideCrack: {
    width: 8,
    height: 1,
    backgroundColor: '#666',
