...
from gecici_iskan_planlama import GeciciIskanPlanlamaTab
from satellite_detection.satellite_ui import SatelliteDetectionTab
...
class AfetYonetimAdmin(QMainWindow):
    ...
    def initUI(self):
        ...
        self.all_tabs = [
            ...
            ("Uydu Görüntü Tespiti", SatelliteDetectionTab()),
        ]
