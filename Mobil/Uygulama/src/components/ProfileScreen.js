...
import { View, Text, StyleSheet, Image, TouchableOpacity, TextInput, ScrollView, Alert, Keyboard } from 'react-native';
import { useDispatch, useSelector } from 'react-redux';
import { getUser, logout } from '../redux/userSlice';
import { Loading, CustomButton, UpdatePassword } from './index.js';
import { FontAwesomeIcon } from '@fortawesome/react-native-fontawesome';
import { faEnvelope, faPhone, faSignOutAlt, faPaperPlane, faUser, faEdit } from '@fortawesome/free-solid-svg-icons';
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.feedbackContainer}>
            ...
            <TouchableOpacity style={styles.submitButton} onPress={handleFeedbackSubmit}>
              <FontAwesomeIcon icon={faPaperPlane} size={18} color="#fff" style={styles.submitIcon} />
